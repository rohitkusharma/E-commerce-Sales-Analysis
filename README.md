...
## Dataset
The dataset used is the **[Sample - Superstore Dataset](https://www.kaggle.com/datasets/bravehart101/sample-supermarket-dataset)** from Kaggle. It contains sales data for a US-based superstore.
